...
typeB_indexer = StringIndexer(inputCol="type_bien", outputCol="type_bien_index")
type_B_encoder = OneHotEncoder(inputCol="type_bien_index", outputCol="type_bien_encoded")
...
# Create pipeline
pipeline = Pipeline(stages=[typeB_indexer, type_B_encoder, assembler, normalizer])
